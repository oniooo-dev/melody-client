...
interface AudioSelectedClipProps {
    clipId: string;
    clipName: string;
...
const AudioSelectedClip: React.FC<AudioSelectedClipProps> = ({
    clipId,
    clipName,
    handleChange,
    handleBlur,
        ...
        <div className="flex flex-col h-full w-full bg-gray-200">
            ...
            <div className="p-4 border-b border-gray-700">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <h2 className="text-base font-medium">Audio Clip Properties</h2>
                </div>
                <input
                    type="text"
                    value={clipName}
...
export default AudioSelectedClip;